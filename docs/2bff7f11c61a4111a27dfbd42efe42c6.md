...
## Class Reference
The Button class provided by OpenSilver is as follows:
...
For detailed class definitions, inheritance hierarchy, properties, events, methods, and more, refer to the [Button Class Reference Document](https://example.com/button-reference).
