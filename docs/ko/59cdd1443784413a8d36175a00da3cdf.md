...
[tabgroup]  
[tab=XAMLurl=https://github.com/OpenSilver/samples/blob/master/src/OpenSilver.Samples/OSFSample.ButtonCommand/ButtonCommandExample.xaml|text=GitHub: ButtonCommandExample.xaml]  
```
<StackPanel HorizontalAlignment="Left">  
