...
[tabgroup]  
[tab=XAML|url=https://github.com/OpenSilver/samples/blob/master/src/OpenSilver.Samples/OSFSample.ButtonContent/ButtonContentExample.xaml|text=ButtonContentExample.xaml]  
```
