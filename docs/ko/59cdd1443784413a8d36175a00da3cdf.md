...
```
[/tab]  
[tab=C#|url=https://github.com/OpenSilver/samples/blob/master/src/OpenSilver.Samples/OSFSample.ButtonClick/ButtonClickExample.xaml.cs|text=ButtonClickExample.xaml.cs]  
```
