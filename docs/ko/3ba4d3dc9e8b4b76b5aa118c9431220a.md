...
opensilverapp1.browser 디버그 버튼 클릭 또는 F5 또는 Ctrl + F5하는 모습 어쩌구 설명

_Edge 에서 실행한 모습 어쩌구_
...
_이미지 설명 어쩌구 ctrl + shft-b눌럿을 때 opensilverapp1.browser 프로젝트 dotnet: build선택하는 그 장면임_
...
## 실행  
Visual Studio Code의 devkit c#인가 그거 F5 누르면 아래처럼 저렇게뜨는거에서 OpenSilverApp1.Browser 프로젝트선택

_시작 플로젝트 선택하라는거 나오는 이미지임 C#: OpenSilverApp1.Browser 이거랑 .Simuulator 목록 중에 선택하는 장명임_
...
여기 크롬브라우저로나온 결과 어쩌구 http://localhost:55592 이게기본임 그리구 Hello, OpenSilver!  텍스트와 버튼 체크박스 나온거 어쩌구결과