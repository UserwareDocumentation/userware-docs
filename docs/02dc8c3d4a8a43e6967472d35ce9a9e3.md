...
| IsAutoWidthOnCustomLayout | Nullable<bool> | Gets or sets (Inherited from FrameworkElement) |
| IsAutoHeightOnCustomLayout | Nullable<bool> | Gets or sets (Inherited from FrameworkElement) |
